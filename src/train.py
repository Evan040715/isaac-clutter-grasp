...
if __name__ == "__main__":
    ...
    # --- 参数解析部分保持不变 ---
    # The argument parsing section remains unchanged.
    parser = get_args_parser()
    # ... (All parser.add_argument lines are kept the same as the original)
    ...
    # --- 核心改动 1: 在此为您的任务添加一个新的分支 ---
    # --- Core Modification 1: Add a new branch for your task here ---
    elif args.exp_name == "ClutterGrasp":
        print("--- Using ClutterGrasp experiment settings ---")
        obs_space = [
            "arm_dof_pos",
            "arm_dof_vel",
            "hand_dof_pos",
    ...
    # --- 核心改动 2: 将任务名称写死为 "ClutterGrasp" ---
    # --- Core Modification 2: Hardcode the task name to "ClutterGrasp" ---
    env = load_isaacgym_env(
        task_name="ClutterGrasp", args=args
    )
